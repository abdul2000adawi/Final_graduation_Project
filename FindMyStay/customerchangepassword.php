...
{
	$sql = "UPDATE customer SET password='$_POST[npassword]' WHERE password='$_POST[opassword]' AND  customer_id='$_SESSION[customer_id]'";
...
<div> 
	...
	<span><input name="opassword" id="opassword" type="Password" class="form-control" ></span>
</div>

<div> 
	<span><label>New Password</label></span>
	<span><input name="npassword" id="npassword" type="Password" class="form-control" ></span>
</div>
<div> 
	<span><label>Confirm Password</label></span>
	<span><input name="cpassword" id="cpassword" type="Password" class="form-control" ></span>
</div>
						   <div>
