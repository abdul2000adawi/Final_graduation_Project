	...
	<table class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			...
			<tr>
				...
				<th style="width:75%;">
				<input type="date" min="<?php echo date("Y-m-d",strtotime($checkindt)); ?>" max="<?php echo date("Y-m-d",strtotime($checkoutdt)); ?>" name="deldate" id="deldate">
				</th>
			</tr>
			<tr>
				<th style="width:25%;">Delivery Time</th>
				<th style="width:75%;">
				<input type="time" name="deltime" id="deltime">
				</th>
			</tr>
			<tr>
	...
	<table class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			...
			<tr>
				...
				<th style="width:75%;">   <div class="col-md-12"> 
		<span>
...
alert("Item order payment done successfully...");				window.location='foodorderreceipt.php?paymentid='+data;
